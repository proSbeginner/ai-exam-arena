...
function toInput(question: ExamQuestion): AdminQuestionFormState {
  return { ...emptyForm, ...question, labels: question.labels ?? [], labelInput: '', funFact: question.funFact ?? '', chapter: question.chapter ?? '', sourceName: question.source?.name ?? '', sourceUrl: question.source?.url ?? '', sourceReference: question.source?.reference ?? '' };
}
