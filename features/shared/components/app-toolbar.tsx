...
export function AppToolbar({
  ...
  return (
    <header className={`mx-auto flex w-full max-w-lg items-center justify-between py-4 transition-transform duration-300 ${isHidden ? '-translate-y-full pointer-events-none' : 'translate-y-0'}`}>
